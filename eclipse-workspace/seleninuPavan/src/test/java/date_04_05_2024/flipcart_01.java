...
public class flipcart_01 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@placeholder='Search for Products, Brands and More']")).sendKeys("iphone 15 pro max");
	Thread.sleep(2000);
	String mainpage = driver.getWindowHandle();
		driver.findElement(By.xpath("//button[@title='Search for Products, Brands and More']//*[name()='svg']")).click();
    driver.findElement(By.xpath("//div[text()='Apple iPhone 15 Pro Max (Natural Titanium, 256 GB)']")).click();
